...
export default function Navbar() {
    ...
    return (
        <div className='bg-neutral-300 dark:bg-stone-900 text-3xl dark:text-neutral-100 text-stone-900  px-5 p-3 flex justify-between items-center theme-transission'>
